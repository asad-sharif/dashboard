...
const Home = () => {
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
      ...
      <div className='bg-primary-foreground rounded-md p-4 flex flex-col items-start justify-center'>
        <h2 className='mb-2 font-semibold text-lg'>Pending Tasks</h2>
        <span className='text-3xl font-bold'>32</span>
        <span className='text-xs text-muted-foreground mt-1'>Updated daily</span>
      </div>
      <div className='bg-primary-foreground rounded-md py-4 pl-4 col-span-2'>
